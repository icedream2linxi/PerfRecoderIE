// PerfRecorder.h : Declaration of the CPerfRecorder
...
#include "_IPerfRecorderEvents_CP.h"
...
class ATL_NO_VTABLE CPerfRecorder :
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CPerfRecorder, &CLSID_PerfRecorder>,
	public ISupportErrorInfo,
	public IConnectionPointContainerImpl<CPerfRecorder>,
	public CProxy_IPerfRecorderEvents<CPerfRecorder>,
	public IObjectWithSiteImpl<CPerfRecorder>,
	public IObjectSafetyImpl<CPerfRecorder, INTERFACESAFE_FOR_UNTRUSTED_CALLER | INTERFACESAFE_FOR_UNTRUSTED_DATA>,
	public IDispatchImpl<IPerfRecorder, &IID_IPerfRecorder, &LIBID_PerfRecorderIELib, /*wMajor =*/ 1, /*wMinor =*/ 0>
{
private:
...
DECLARE_REGISTRY_RESOURCEID(IDR_PERFRECORDER)


BEGIN_COM_MAP(CPerfRecorder)
	COM_INTERFACE_ENTRY(IPerfRecorder)
...
BEGIN_CONNECTION_POINT_MAP(CPerfRecorder)
	CONNECTION_POINT_ENTRY(__uuidof(_IPerfRecorderEvents))
...
OBJECT_ENTRY_AUTO(__uuidof(PerfRecorder), CPerfRecorder)
